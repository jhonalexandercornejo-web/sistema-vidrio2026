...
async function eliminarPedido(id) {
    ...
    const confirmar =
        confirm(
            ...
            `¿Seguro que quieres eliminar la OP ${pedido.op}?\n\n` +
    ...
    try {
        ...
        alert(
            `La OP ${pedido.op} fue eliminada correctamente.`
        );
